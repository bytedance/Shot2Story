...
<!-- New Playtime Guide Section -->
<div style='margin-top: 20px; background-color: #f0f8ff; padding: 15px; border-radius: 10px;'>
  <h4 style='color: #2a9df4;'>🎉 Playtime Guide</h4>
  <p>😄 For more comprehensive understanding, try to specify reasonable starting and ending timestamps for the shots. Enjoy!</p>
  <p>😄 For grounded video-text understanding, set temperature for story generation to 0.1.</p> 
  <p>😄 For creative video-text understanding, set temperature for story generation greater value, e.g., 1.0.</p>
</div>
"""
